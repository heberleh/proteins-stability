...
if __name__ == '__main__':
    rankes_names = ["rank_nsc.csv","rank_svm_linear.csv","rank_svm_rbf.csv","rank_ttest.csv"]
    classifiers_names = ["nsc","svm-linear","svm-rbf", "tree"]
    
    view_rankes_names = {"rank_nsc.csv":"NSC","rank_svm_linear.csv":"SVM-RFE (linear)","rank_svm_rbf.csv":"SVM-RFE (radial)","rank_ttest.csv": "T-Test"}
