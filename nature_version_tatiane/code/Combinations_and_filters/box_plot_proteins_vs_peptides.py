...
data =  [aucs_proteins,aucs_proteins_smote,aucs_peptides, aucs_peptides_smote]
# Create a figure instance
#fig = plt.figure(1, figsize=(9, 6))

# Create an axes instance
fig, ax = plt.subplots(nrows=1, ncols=1, figsize=(9, 6), sharey=True)#fig.add_subplot(111)
...
ax.set_xticklabels(['63 prot. sig.', '63 prot. sig. (SMOTE)', '1024 pep. sig.','1024 pep. sig. (SMOTE)'])
...
ax.legend([bp['means'][0], bp['medians'][0]], ['Mean', 'Median'], loc='lower right')

# Save the figure , bbox_inches='tight'
fig.savefig('boxplot_proteins_vs_peptides_signatures_AUC.png')