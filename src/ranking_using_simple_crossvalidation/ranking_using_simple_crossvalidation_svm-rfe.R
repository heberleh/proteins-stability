...
write.csv(result, file = "./results/ranking_using_simple_crossvalidation/svm-rfe/cv_result_avg_repetitions.csv")
...
write.csv(result, file = "./results/ranking_using_simple_crossvalidation/svm-rfe/genes_freq_matrix_cv_whithout_repetition.csv")




# plot the cv result of rank by freq
pdf("./results/ranking_using_simple_crossvalidation/svm-rfe/freq_rank_cv_svm-rfe.pdf")
